	...
	'object' == typeof exports && 'object' == typeof module
		...
		: 'function' == typeof define && define.amd
			...
			: 'object' == typeof exports
				? (exports.GitHubLogin = t(require('react')))
				: (e.GitHubLogin = t(e.react));
})(this, function(e) {
	return (function(e) {
		function t(r) {
						...
						return (
							...
							(r.onBtnClick = function() {
								var e = r.props,
									...
									u = (r.popup = d.default.open(
										'github-oauth-authorize',
										'https://github.com/login/oauth/authorize?' + i,
										{ height: 1e3, width: 600 }
									));
								r.onRequest(),
								u.then(
									function(e) {
							...
							(r.onSuccess = function(e) {
								if (!e.code) return r.onFailure(new Error('\'code\' not found'));
								r.props.onSuccess(e);
							}),
						...
						c(t, [
							{
								...
								value: function() {
									...
									return (
										t && (o.className = t),
										s.default.createElement('a', o, r || n)
									);
								}
							}
						]),
											...
											e._iid = window.setInterval(function() {
												try {
													...
													if (!r || !1 !== r.closed)
														return (
															e.close(),
															void n(new Error('The popup was closed'))
														);
													if (
														r.location.href === e.url ||
                            'blank' === r.location.pathname
													)
														return;
													var o = (0, i.toParams)(
								...
								},
								{
									...
									value: function() {
										this._iid &&
                      (window.clearInterval(this._iid), (this._iid = null));
									}
								},
								{
									key: 'then',
