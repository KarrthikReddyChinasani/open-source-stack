...
class TopicsPage extends React.Component {
	...
	render() {
		...
		console.log('karthik', topics);
		return (
			<div className="container-fluid search-header">
				<div className="row">
					{!(Object.keys(topics).length === 0 && topics.constructor === Object)
						? topics.topics.map(function(topic) {
							return (
								<div className="col col-md-3" key={topic.title}>
									<section className="cards">
										<article className="card card--1" >
											...
											<div className="card__info">
												<span className="card__category">{topic.title}</span>
